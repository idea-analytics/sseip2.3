...
```{r}
sf_children_poverty <- df_counties_all %>%
  pmap(
    state, county, CENSUS_YEAR, # args???
    get_sf_children_poverty     # function???
  )
