...
sf_children_in_poverty <- sf_acs_all %>%
...
# st_write_feather(sf_children_by_age_group_block_group, glue::glue("{working_dir}/sf_children_by_age_group_block_group_dd_2022.feather"))
```
...
# st_write_feather(sf_children_by_age_group_tract, glue::glue("{working_dir}/sf_children_by_age_group_tract_dd_2022.feather"))
```
...
# st_write_feather(sf_household_income, glue::glue("{working_dir}/sf_household_income_dd_2022.feather"))
```
...
# st_write_feather(sf_students_in_poverty, glue::glue("{working_dir}/sf_students_in_poverty_dd_2022.feather"))
```
